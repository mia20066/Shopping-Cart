...
const initState = {
    items: [
        ...
        {id:3,title:'Gyro Dinner', desc: "Grilled Gyro meat, served on a bed of rice, with a side of tomato sauce. Served with pita and a side house salad.",price:120,img: Item3},
